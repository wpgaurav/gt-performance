...
Run `build-product-page.php` with the public dashboard and CSS-report attachment URLs to create the WordPress-ready `marketers-delight/inline-page-block` stored in `fluentcart/product-page.wordpress.html`.
