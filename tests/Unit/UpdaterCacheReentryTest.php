...
final class UpdaterCacheReentryTest extends TestCase {
	protected function setUp(): void {
		$GLOBALS['gtperf_test_transient_deletions']             = array();
		$GLOBALS['gtperf_test_deleted_site_transient_listener'] = null;
	}
	...
	public function test_clear_cache_deletes_the_update_transient(): void {
		...
		self::assertCount( 1, $GLOBALS['gtperf_test_transient_deletions'] );
		self::assertStringStartsWith( 'gtperf_fluentcart_update_', $GLOBALS['gtperf_test_transient_deletions'][0] );
	}
	...
	public function test_clear_cache_does_not_recurse_when_deletion_re_enters_it(): void {
		$GLOBALS['gtperf_test_deleted_site_transient_listener'] = static function (): void {
			Updater::clearCache();
		};
	...
	public function test_guard_is_released_for_later_calls(): void {
		...
		self::assertCount( 2, $GLOBALS['gtperf_test_transient_deletions'] );
	}
}
