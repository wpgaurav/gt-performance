...
final class CompatibilityModuleTest extends TestCase {
	...
	public function testEwwwWebpConversionOwnsModernImageVariants(): void {
		$this->activateEwww();
		$GLOBALS['gtperf_test_options']['ewww_image_optimizer_webp'] = true;
	...
	public function testEwwwLazyLoadOnlyYieldsOverlappingMediaFeatures(): void {
		$this->activateEwww();
		$GLOBALS['gtperf_test_options']['ewww_image_optimizer_lazy_load'] = true;
		...
		$GLOBALS['gtperf_test_options']['ewww_image_optimizer_add_missing_dims'] = true;
	...
	public function testEasyIoOwnsAllOverlappingImageFeatures(): void {
		$this->activateEwww();
		$GLOBALS['gtperf_test_options']['easyio_exactdn'] = true;
	...
	private function activateEwww(): void {
		$GLOBALS['gtperf_test_options']['active_plugins'] = array( 'ewww-image-optimizer/ewww-image-optimizer.php' );
	}
}
