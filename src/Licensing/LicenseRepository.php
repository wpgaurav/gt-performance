...
final class LicenseRepository {
	...
	public function licenseKey(): string {
		...
		return $this->keyCipher->decrypt( (string) $state['license_key'], 'GTPERF_LICENSE_KEY' );
	}
	...
	public function isConstantManaged(): bool {
		return defined( 'GTPERF_LICENSE_KEY' ) && is_string( GTPERF_LICENSE_KEY ) && '' !== trim( GTPERF_LICENSE_KEY );
	}
